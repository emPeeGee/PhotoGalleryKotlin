...
class ThumbnailDownloader<in T>(
    ...
    val fragmentLifecycleObserver: LifecycleObserver = object : LifecycleObserver {
        ...
        fun setup() {
            Log.i(TAG, "Starting backgroundThread")
        ...
        fun tearDown() {
            Log.i(TAG, "Destroying backgroundThread")
    ...
    val viewLifecycleOwner: LifecycleObserver = object : LifecycleObserver {
        ...
        requestHandler = object : Handler() {
            override fun handleMessage(msg: Message) {
                if (msg.what == MESSAGE_DOWNLOAD) {
                    ...
                    Log.i(TAG, "Got a requset from URL: ${requestMap[target]}")
